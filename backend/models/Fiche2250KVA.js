...
const pointControleSchema = new mongoose.Schema({
...
const fiche2250KVASchema = new mongoose.Schema({
    date: { type: Date, required: true },
    designation: { type: String, required: true },
    lieuInstallation: { type: String, required: true },

    // ✅ nouveau nom
    pointsControle: [pointControleSchema],
...
module.exports = mongoose.model('Fiche2250KVA', fiche2250KVASchema);