              ...
              <li>
                ...
                {interventionOpen && activeMenu === 'intervention' && (
                  ...
                  >
                    ...
                    {/* ➕ Nouveau sous-menu Historique */}
                    <li
                      className={activeSubMenu === 'historique' ? 'active' : ''}
                      onClick={(e) => {
                        e.stopPropagation();
                        setActiveSubMenu('historique');
                        navigate('/historique-actions-tech'); // 🔥 redirection vers la page HistoriqueTechnicien
                      }}
                      style={{
                        cursor: 'pointer',
                        padding: '4px 0',
