...
const initialoperation = [
  {
    specification: '',
    designation: 'Etat du panneau avertisseur "Power Wizard"',
  ...
  {
    specification: '',
    designation: 'Niveau de gasoil dans le réservoir en %',
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
  ...
  {
    specification: '',
    designation: 'Etat  des conduites et de la pompe à gasoil',
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
  {
    specification: '',
    designation: "Etat  de séparateur d'eau",
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
  {
    specification: '',
    designation: 'Etat des batteries et cosses',
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
  {
    specification: '',
    designation: 'Etat de disjoncteur GPE',
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
  {
    specification: '',
    designation: "Etat de l'inverseur",
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
  ...
  },
  {
    specification: '',
    designation:
      'Etat des connections, branchements des câbles électriques, relais et cartes électroniques',
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
  {
    specification: '',
    designation:
      'Etat des circuits de commande des pompes et indicateur jaugeage des citernes',
    matin: { normal: false, anomalie: false },
    apresMidi: { normal: false, anomalie: false },
    nuit: { normal: false, anomalie: false },
  },
...
export default function FicheOlapionForm() {
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ margin: '0' }}>Doc N°:TAVTUN/NBE.TD.BAL.FM.035</p>
      </div>
    </form>
  );
}
