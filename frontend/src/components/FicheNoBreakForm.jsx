...
import { enregistrerFicheNoBreak, envoyerFicheNoBreak } from './apiservices/api';
...
const initialControles = [
  { specification: "", designation: "Contrôler l'écran de l'UNIBLOCK et d'armoire groupe Easy gen", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Pression d'hélium en bar", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Détendeur 1 0-200bar", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Détendeur 2  5 bar", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Détendeur 3 0,2,0,3bar", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Etat de graissage PB", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  ...
  { specification: "", designation: "Niveau d’huile DIESEL et EMBRAYAGE", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  ...
  { specification: "", designation: "Etat du séparateur d'eau", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Niveau de gasoil  dans la nourrisse en %", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Etat  de la pompe à gasoil", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Etat des batteriEtat  de la pompe à gasoiles et cosses de Diesel +UNIBLOCK", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Etat d'indicateur de colmatage de filtre à air Diesel ", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Etat des Filtres à air UNIBLOCK", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Etat des connections, branchements des câbles électriques, relais , Fusibles et cartes électroniques", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
  { specification: "", designation: "Etat du disjoncteur de couplage", matin: { normal: false, anomalie: false }, apresMidi: { normal: false, anomalie: false }, nuit: { normal: false, anomalie: false } },
...
export default function FicheNoBreakForm() {
  ...
  useEffect(() => {
    ...
    const tempsMatin = calcTemps(fiche.tempsInspection.matin.debut, fiche.tempsInspection.matin.fin);
    const tempsApres = calcTemps(fiche.tempsInspection.apresMidi.debut, fiche.tempsInspection.apresMidi.fin);
    const tempsNuit = calcTemps(fiche.tempsInspection.nuit.debut, fiche.tempsInspection.nuit.fin);
    ...
    const total = `${Math.floor(totalMinutes/60).toString().padStart(2,"0")}:${(totalMinutes%60).toString().padStart(2,"0")}`;
    setFiche({
      ...fiche,
      tempsInspection: {
        matin: {...fiche.tempsInspection.matin, tempsAlloue: tempsMatin},
        apresMidi: {...fiche.tempsInspection.apresMidi, tempsAlloue: tempsApres},
        nuit: {...fiche.tempsInspection.nuit, tempsAlloue: tempsNuit},
        total
      }
    });
  }, [fiche.tempsInspection.matin.debut, fiche.tempsInspection.matin.fin,
      fiche.tempsInspection.apresMidi.debut, fiche.tempsInspection.apresMidi.fin,
      fiche.tempsInspection.nuit.debut, fiche.tempsInspection.nuit.fin]);
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: "1000px", margin: "auto" }}>
      ...
      <div style={{ display: "flex", gap: "20px" }}>
        <div style={{ flex: 1 }}>
          <label>Date</label>
          <DatePicker selected={fiche.date} onChange={(date) => handleChange("date", date)} className="input"/>
